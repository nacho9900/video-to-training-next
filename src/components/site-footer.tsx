        ...
        <nav className="flex items-center gap-1">
          {links.map((link) => (
            <a
              ...
              className="flex size-8 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-muted hover:text-foreground [&_svg]:size-[18px]"
            >
              {link.icon}
            </a>
          ))}
